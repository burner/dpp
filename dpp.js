{
	"Token" : [
		...
		{ Name : "Ulong_Value", "Regex" : "[0-9]+l", 
			"ConvertFunction" : "void" }
		{ Name : "Float_Value", "Regex" : "[0-9]+.[0-9]+f", 
			"ConvertFunction" : "void" }
		{ Name : "Double_Value", "Regex" : "[0-9]+.[0-9]+", 
			"ConvertFunction" : "void" }
		{ Name : "Real_Value", "Regex" : "[0-9]+.[0-9]+r", 
			"ConvertFunction" : "void" }
	...
	"Rules" : [
		...
		{ Name : "PrimativeExpression", Expression : [
			{ Rule : "Ubyte_Value(value) ", Id : "UByteValue" }
			{ Rule : "Ushort_Value(value) ", Id : "UShortValue" }
			{ Rule : "Uint_Value(value) ", Id : "UIntValue" }
			{ Rule : "Ulong_Value(value) ", Id : "ULongValue" }
			{ Rule : "Byte_Value(value) ", Id : "ByteValue" }
			{ Rule : "Short_Value(value) ", Id : "ShortValue" }
			{ Rule : "Int_Value(value) ", Id : "IntValue" }
			{ Rule : "Long_Value(value) ", Id : "LongValue" }
			{ Rule : "Float_Value(value) ", Id : "FloatValue" }
			{ Rule : "Double_Value(value) ", Id : "DoubleValue" }
			{ Rule : "Real_Value(value) ", Id : "RealValue" }
			{ Rule : "String(value) ", Id : "StringValue" }
			{ Rule : "True ", Id : "True" }
			{ Rule : "False ", Id : "False" }
			]
		}
